...
spec = do
  ...
  describe "card2" $ do
    it "should work in basic case" $ do
      let newBoard = playCard 0 card2 testGS_Board123
  ...
  describe "card4" $ do
    it "should work in basic case" $ do
      ...
      let newBoard = playCard 0 card4 gs
  ...
  describe "card5" $ do
    it "should work in basic case" $ do
      let newBoard = playCard 0 card5 testGS_Board123
      newBoard `shouldBe` (testGS_Board123 & (playerState . element 0 . board) .~ map NumberCard [0, 2, 4])
  describe "card6" $ do
    it "should work in basic case " $ do
      let newBoard = playCard 0 card6 testGS_Board123
  ...
  describe "card9" $ do
    it "should work in basic case" $ do
      ...
      let newBoard = playCard 0 card9 gs
  ...
  describe "card10" $ do
    it "should work in basic case" $ do
      ...
      let newBoard = playCard 0 (card10 (NumberCard 3) (NumberCard 4)) gs
  ...
  describe "card12" $ do
    it "should work in basic case" $ do
      let newBoard = playCard 0 card12 testGS_Board123
